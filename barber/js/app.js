(() => {
    ...
    showMoreBtn.addEventListener("click", (() => {
        ...
        if (0 === hiddenElements.length) showMoreBtn.className = "d-none";
    }));
    let langs = document.querySelector(".header__langs"), script_link = document.querySelectorAll(".header__lang"), book = document.querySelector(".header__button"), menuProducts = document.querySelector("#menu__products"), menuPrice = document.querySelector("#menu__price"), menuContact = document.querySelector("#menu__contact"), mainDate = document.querySelector(".main__date"), titleP = document.querySelector(".title__p"), titleOrange = document.querySelector(".title__orange"), mainText = document.querySelector(".main__text"), cutTop = document.querySelector(".cut__top");
    ...
    script_link.forEach((el => {
        el.addEventListener("click", (() => {
            ...
            book.textContent = script_data[attr].book;
            menuProducts.textContent = script_data[attr].menuProducts;
            menuPrice.textContent = script_data[attr].menuPrice;
            menuContact.textContent = script_data[attr].menuContact;
            mainDate.textContent = script_data[attr].mainDate;
            titleP.textContent = script_data[attr].titleP;
            titleOrange.textContent = script_data[attr].titleOrange;
            mainText.textContent = script_data[attr].mainText;
            cutTop.textContent = script_data[attr].cutTop;
            cutSpan1.textContent = script_data[attr].cutSpan1;
            cutSpan2.textContent = script_data[attr].cutSpan2;
            cutp1.textContent = script_data[attr].cutp1;
            shavingTop.textContent = script_data[attr].shavingTop;
            shavingSpan1.textContent = script_data[attr].shavingSpan1;
            shavingSpan2.textContent = script_data[attr].shavingSpan2;
            shavingp1.textContent = script_data[attr].shavingp1;
            shavingp2.textContent = script_data[attr].shavingp2;
            popupLink.textContent = script_data[attr].popupLink;
            careTop.textContent = script_data[attr].careTop;
            careSpan1.textContent = script_data[attr].careSpan1;
            careSpan2.textContent = script_data[attr].careSpan2;
            carep1.textContent = script_data[attr].carep1;
            productsButton.textContent = script_data[attr].productsButton;
            slide1Title.textContent = script_data[attr].slide1Title;
            slide1item1.textContent = script_data[attr].slide1item1;
            slide1item2.textContent = script_data[attr].slide1item2;
            slide1item3.textContent = script_data[attr].slide1item3;
            slide1item4.textContent = script_data[attr].slide1item4;
            slide1item5.textContent = script_data[attr].slide1item5;
            slide2Title.textContent = script_data[attr].slide2Title;
            slide2item1.textContent = script_data[attr].slide2item1;
            slide2item2.textContent = script_data[attr].slide2item2;
            slide2item3.textContent = script_data[attr].slide2item3;
            slide3Title.textContent = script_data[attr].slide3Title;
            slide3item1.textContent = script_data[attr].slide3item1;
            slide3item2.textContent = script_data[attr].slide3item2;
            slide3item3.textContent = script_data[attr].slide3item3;
            slide3item4.textContent = script_data[attr].slide3item4;
            slide3item5.textContent = script_data[attr].slide3item5;
            slide3item6.textContent = script_data[attr].slide3item6;
            slide4Title.textContent = script_data[attr].slide4Title;
            slide4item1.textContent = script_data[attr].slide4item1;
            slide4item2.textContent = script_data[attr].slide4item2;
            slide4item3.textContent = script_data[attr].slide4item3;
            slide4item4.textContent = script_data[attr].slide4item4;
            slide4item5.textContent = script_data[attr].slide4item5;
            slide4item6.textContent = script_data[attr].slide4item6;
            slide4item7.textContent = script_data[attr].slide4item7;
            slide4item8.textContent = script_data[attr].slide4item8;
            slide5Title.textContent = script_data[attr].slide5Title;
            slide5item1.textContent = script_data[attr].slide5item1;
            slide5item2.textContent = script_data[attr].slide5item2;
            slide5item3.textContent = script_data[attr].slide5item3;
            slide6Title.textContent = script_data[attr].slide6Title;
            slide6item1.textContent = script_data[attr].slide6item1;
            slide6item2.textContent = script_data[attr].slide6item2;
            slide6item3.textContent = script_data[attr].slide6item3;
            slide6item4.textContent = script_data[attr].slide6item4;
            slide7Title.textContent = script_data[attr].slide7Title;
            slide7item1.textContent = script_data[attr].slide7item1;
            slide7item2.textContent = script_data[attr].slide7item2;
            slide7item3.textContent = script_data[attr].slide7item3;
            slide7item4.textContent = script_data[attr].slide7item4;
            slide7item5.textContent = script_data[attr].slide7item5;
            slide7item6.textContent = script_data[attr].slide7item6;
            slide8Title.textContent = script_data[attr].slide8Title;
            slide8item1.textContent = script_data[attr].slide8item1;
            slide8item2.textContent = script_data[attr].slide8item2;
            slide8item3.textContent = script_data[attr].slide8item3;
            slide8item4.textContent = script_data[attr].slide8item4;
            slide9Title.textContent = script_data[attr].slide9Title;
            slide9item1.textContent = script_data[attr].slide9item1;
            slide9item2.textContent = script_data[attr].slide9item2;
            slide10Title.textContent = script_data[attr].slide10Title;
            slide10item1.textContent = script_data[attr].slide10item1;
            slide10item2.textContent = script_data[attr].slide10item2;
            slide10item3.textContent = script_data[attr].slide10item3;
            contactTop.textContent = script_data[attr].contactTop;
            contactTitle.textContent = script_data[attr].contactTitle;
        }));
    }));
    let script_data = {
        slovenian: {
            ...
            cutSpan1: "izbor ",
            cutSpan2: "frizur",
            cutp1: "Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor purus non t aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor purus non.",
            shavingTop: "britje",
            shavingSpan1: "kaj delamo z ",
            shavingSpan2: "brado",
            shavingp1: "Vikingova brada - gosta in lepa!",
            shavingp2: "Za brado imamo dva načina urejanja: navadno urejanje z mašincami, britvicami in škarjami in kraljevo britje na turški način!",
            popupLink: "Več o tem...",
            careTop: "nega",
            careSpan1: "izdelki",
            careSpan2: " za nego",
            carep1: "Lorem ipsum dolor sit amet, consectetur adipiscing elit aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna, porttitor rhoncus dolor purus non t aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna,porttitor rhoncus dolor purus non.",
            ...
            slide4Title: "👑Kombo Premium: Striženje + Urejanje brade po turško + Styling",
            ...
            slide6item4: "Pri delu se uporablja visoko-kakovostni materjal in kozmetika.",
            ...
            slide8item1: "Britje brade na gladko nulo z britvico z uporabo vročih brisač.",
            ...
            slide8item4: "Temu sledi krema za obraz, ki pomiri kožo in kolonska, da kožo razkuži.",
            slide9Title: "Hladno Britje",
            slide9item1: "Britje brade na gladko nulo z električnim brivnikom z uporabo praha.",
            slide9item2: "Temu sledi krema za obraz, ki pomiri kožo in kolonska, da kožo razkuži.",
        ...
        english: {
            ...
            shavingp2: "For the beard, we have two methods of trimming: regular trimming with trimmers, razors and scissors and royal shaving in the Turkish way!",
            popupLink: "Read more...",
            careTop: "Care",
            careSpan1: "care",
            careSpan2: " products",
            ...
            slide8item1: "Shaving your beard to a smooth finish with a razor using hot towels.",
            slide8item2: "Massaging the face using electric massagers.",
            slide8item3: "Skin softening using a device that emits hot steam.",
            slide8item4: "This is followed by a face cream to soothe the skin and a cologne to disinfect the skin.",
            slide9Title: "Cold Shaving",
            slide9item1: "Shaving your beard to a smooth finish with an electric shaver using powder.",
            slide9item2: "This is followed by a face cream to soothe the skin and a cologne to disinfect the skin.",
